...
{
    public class VenuePageService : IVenuePageService
    {
        private readonly IVenueService _venueService;
        private readonly IMapper _mapper;
        private readonly ILogger<VenuePageService> _logger;

        public VenuePageService(IVenueService venueService, IMapper mapper, ILogger<VenuePageService> logger)
        {
