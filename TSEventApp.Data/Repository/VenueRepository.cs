...
namespace TSEventApp.Infrastructure.Repository
{
    internal class VenueRepository : Repository<Venue>, IVenueRepository
    {
        ...
        public async Task<int> createVenue(Venue _venue)
        {
            ...
            await _eventContext.Venue.AddAsync(newVenue);
        ...
        {
            var result = await(from e in _eventContext.Venue
        ...
        {
           return await _eventContext.Venue.OrderBy(x=>x.MaxCapacity).ToListAsync();
        }

        public int UpdateVenue(Venue _venue)
        {
            _eventContext.Venue.Update(_venue);
        ...
        {
           return await _eventContext.Venue.FindAsync(venueId);
        }
    }
}
